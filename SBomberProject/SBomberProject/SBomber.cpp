...
void SBomber::ProcessKBHit()
{
    ...
    LoggerSingleton(FileLoggerSingleton::getInstance()).WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    LoggerSingleton(FileLoggerSingleton::getInstance()).WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
